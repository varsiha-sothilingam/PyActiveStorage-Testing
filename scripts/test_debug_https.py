...
def test_response_https():
    ...
    #ukesm/TerraFIRMA/esm-piControl/r1i1p1f1/Amon/ta/gn/v20241002/ta_Amon_UKESM1-2-LL_esm-piControl_r1i1p1f1_gn_210001-214912.nc"
...
def test_response_s3():
    ...
    bigger_file = "cl_Amon_UKESM1-0-LL_ssp370SST-lowNTCF_r1i1p1f2_gn_205001-209912.nc"  # 17GB 64 HDF5 chunks
    ...
    #    chunk_min = active[i : i+1, :, :, :].min(axis=(0, 1))[:]
    #    all_mins.append(chunk_min)

    #result = np.min(all_mins, axis=0)

    active.min()[0:10, 0:19, 0:144, 0:192]
